...
`;
  ...
  const realizadas = tareasFiltradas.filter(
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-black p-5 pb-28">
      ...
      {pasarId && (
        ...
        <div className="bg-white dark:bg-gray-900 p-6 rounded-3xl shadow space-y-4 mb-8">
      ...
      <div className="bg-white dark:bg-gray-900 p-6 rounded-3xl shadow space-y-4">
